...
def main_tab():
   global sol, default_rover, default_cam, sol_entry
   ...
   cam_selection = OptionMenu(main_frame, default_rover, *rover_list)
   ...
   cam_selection = OptionMenu(main_frame, default_cam, *cam_list)
   cam_selection.pack(pady=10)
   get_data_btn = Button(text="Get Data", color="white", bg="#1EE8A0", width=30)
...
def result_tab():
    ...
    go_back_btn=Button(text="Go Back", color="white", bg="#1EE8A0", width=30)
